    ...
    <div class="page-box">
     ...
     <form id="demo-form" class="form-horizontal" method="post" action="<?php echo SITE_ROOT;?>index.php?controller=user&action=registerdept" data-parsley-validate="">
                ...
                <span class="required">*</span>
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" autocomplete="off" type="text" name="deptname" value="<?php echo @$deptDetails['deptname'];?>"  required>
                    </div>
                </div>
         <div class="form-group">
                    <label for="" class="col-sm-3 control-label">
          ...
          <div class="col-sm-offset-3 col-sm-8">
            <input type="hidden" name="updatedeptid" value="<?php echo @$deptDetails['updatedeptid'];?>" /><br/>
