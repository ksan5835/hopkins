        ...
        <div class="col-md-6">
            ...
            <div class="profile-box content-box remove-border">
                <div class="content-box-header clearfix bg-default">
                    <img width="46" class="img-bordered border-gray img-circle" src="assets-minified/dummy-images/gravatar.jpg" alt="">
                    <div class="user-details">
                        John Applebee
                    ...
                    <div class="tl-item">
                        ...
                        <div class="popover left">
                            ...
                            <div class="popover-content">
                                <h3 class="tl-title">Lorem ipsum</h3>
                                <p class="tl-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</p>
                                <div class="tl-time">
                ...
                <div class="tl-row">
                    <div class="tl-item float-right">
                        ...
                        <div class="popover right">
                            ...
                            <div class="popover-content">
                                <h3 class="tl-title">Lorem ipsum</h3>
                                <p class="tl-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis pede.</p>
                                <div class="tl-time">
                                    <i class="glyph-icon icon-clock-o"></i>
                                    a few seconds ago
                                </div>
                ...
                <div class="tl-row">
                    <div class="tl-item">
                        ...
                        <div class="popover left">
                            ...
                            <div class="popover-content">
                                <h3 class="tl-title">Lorem ipsum</h3>
                                <p class="tl-content">Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</p>
                                <div class="tl-time">
                                    <i class="glyph-icon icon-clock-o"></i>
                                    a few seconds ago
                                </div>
...
<!--[if gte IE 9]>
    ...
    <script type="text/javascript" src="<?php echo TEMPLATE_PATH; ?>/assets-minified/js-core/raphael.js"></script>
    <!--<link rel="stylesheet" type="text/css" href="assets-minified/widgets/charts/morris/morris.css">-->
    <script type="text/javascript" src="<?php echo TEMPLATE_PATH; ?>/assets-minified/widgets/charts/morris/morris.js"></script>
